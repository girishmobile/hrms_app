class ProfileModel {
  ...
  ProfileModel.fromJson(Map<String, dynamic> json) {
    ...
    spouseDob = (json['spouse_dob'] != null && json['spouse_dob'] is Map<String, dynamic>)
        ? SpouseDob.fromJson(json['spouse_dob'])
        : null;
    child1Name = json['child1_name'];
    child1Occuption = json['child1_occuption'];
    child1Dob = (json['child1_dob'] != null && json['child1_dob'] is Map<String, dynamic>)
    ...
    maritalStatus = json['marital_status'] == true || json['marital_status'] == "true";

    probationEndDate = (json['probation_end_date'] != null && json['probation_end_date'] is Map<String, dynamic>)
        ? SpouseDob.fromJson(json['probation_end_date'])
        : null;
    joiningDate = (json['joining_date'] != null && json['joining_date'] is Map<String, dynamic>)
    ...
    dateOfBirth = (json['date_of_birth'] != null && json['date_of_birth'] is Map<String, dynamic>)
        ? SpouseDob.fromJson(json['date_of_birth'])
        : null;

    marriageAnniversaryDate = (json['marriage_anniversary_date'] != null && json['marriage_anniversary_date'] is Map<String, dynamic>)
    ...
    createdAt = (json['created_at'] != null && json['created_at'] is Map<String, dynamic>)
        ? SpouseDob.fromJson(json['created_at'])
        : null;
    updatedAt = (json['updated_at'] != null && json['updated_at'] is Map<String, dynamic>)
    ...
    designation = (json['designation'] != null && json['designation'] is Map<String, dynamic>)
 ...
 /*   if (json['user_committee_list'] != null) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (marriageAnniversaryDate != null) {
      data['marriage_anniversary_date'] =
          marriageAnniversaryDate!.toJson();
    }
    ...
    if (userQualification != null) {
      data['user_qualification'] =
          userQualification!.map((v) => v.toJson()).toList();
    }
    if (userAccount != null) {
    ...
    if (userCommitteeList != null) {
      data['user_committee_list'] =
          userCommitteeList!.map((v) => v.toJson()).toList();
    }
    if (userTagList != null) {
