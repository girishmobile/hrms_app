...
class ApiConfig {
  ...
  //used
  static String currentAttendanceRecordUrl =
  ...
  static String getEmployeeCountLeaveUrl =
      "$apiBASEURL/user_leave/getLeaveByEmp";
  ...
  static String getLeaveDataUrl =
      "$apiBASEURL/leave_application/getSelfLeaveRequiredData";
  static String addLeaveUrl =
      "$apiBASEURL/leave_application/save_leave_application";
  static String saveLeaveData =
      "$apiBASEURL/leave_application/save_leave_application";

  static String getAllListingLeaveUrl = "$apiBASEURL/datatable/getAllLeaves";

  static String deleteLeaveUrl =
      "$apiBASEURL/leave_application/delete_leave_application";
  ...
  static String deleteNotificationUrl =
      "$apiBASEURL/activity_box/deleteNotification";
  ...
  static String getAllDesignationUrl =
      "$apiBASEURL/designation/get_all_designation";
  ...
  static String getUserImpressionsUrl =
      "$apiBASEURL/impressions/update-profile-view";
  static String approvedLeaveUrl =
      "$apiBASEURL/leave_application/update_accept_status";
  static String rejectLeaveUrl =
      "$apiBASEURL/leave_application/update_reject_status";
  static String getCurrentMonthIncrementEmpUrl =
      "$apiBASEURL/dashboard/getCurrentMonthIncrementEmp";
  static String getHikAttendanceUrl =
      "$apiBASEURL/dashboard/getHikAttendanceDashboard";
  static String getLeaveDataDashboardUrl =
      "$apiBASEURL/dashboard/getLeaveDataDashboard";
